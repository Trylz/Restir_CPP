...
Should ideally be done by rasterization to save time but doing so amplify flickering in my opinion. So this is WIP see: https://github.com/Trylz/Restir_CPP/pull/2
